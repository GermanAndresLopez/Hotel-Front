...
const Dashboard = () => {
  ...
  const handleAddImage = () => {
    if (currentImage &&
      !editingRoom.imagen.some(img => img === currentImage || img.preview === currentImage) &&
  ...
  const handleAddFeature = () => {
    if (currentFeature && !editingRoom.caracteristicas.includes(currentFeature)) {
      handleEditingRoom({
        ...editingRoom,
    ...
    <Box sx={{ marginTop: 12, marginBottom: 5 }}>
      ...
      <Container sx={{ mt: 4 }}>
        ...
        <Dialog open={open} onClose={handleClose} fullWidth maxWidth="md">
          <DialogTitle>
            {editingRoom?.identificador ? 'Editar Habitación' : 'Nueva Habitación'}
          </DialogTitle>
          <DialogContent
