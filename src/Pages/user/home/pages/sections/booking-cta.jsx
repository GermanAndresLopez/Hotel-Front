      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Reserva Tu Experiencia de <span className="text-purple-600 dark:text-purple-400">Lujo</span>
          </h2>
          ...
          <div className="bg-white dark:bg-secondary/50 p-8 rounded-xl border border-purple-200 dark:border-purple-900/50 mb-8 shadow-sm dark:shadow-none">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="text-center p-4 bg-purple-50 dark:bg-purple-950/50 rounded-lg">
                <h3 className="text-xl font-bold text-purple-600 dark:text-purple-400 mb-2">Habitación Deluxe</h3>
                <p className="text-2xl font-bold mb-1">$199</p>
                <p className="text-sm text-foreground/70">por noche</p>
              </div>

              <div className="text-center p-4 bg-purple-50 dark:bg-purple-950/50 rounded-lg">
                <h3 className="text-xl font-bold text-purple-600 dark:text-purple-400 mb-2">Suite Ejecutiva</h3>
                <p className="text-2xl font-bold mb-1">$299</p>
                <p className="text-sm text-foreground/70">por noche</p>
              </div>

              <div className="text-center p-4 bg-purple-50 dark:bg-purple-950/50 rounded-lg">
                <h3 className="text-xl font-bold text-purple-600 dark:text-purple-400 mb-2">Suite Presidencial</h3>
